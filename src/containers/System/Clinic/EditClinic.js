...
import { createClinic, getAllClinic, updateClinicByIdService } from '../../../services/userService';
...
class EditClinic extends Component {
    ...
    hanldeOnChangeSelectdClinic = async (selectedOption, name) => {
        ...
        const selectedClinic = this.state.dataClinics.find(clinic => clinic.id === selectedOption.value);
